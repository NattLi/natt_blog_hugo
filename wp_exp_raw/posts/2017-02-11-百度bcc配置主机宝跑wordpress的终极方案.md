...
>     <tr>
>       <td class="code">
>         <pre class="bash">cd /a/apps/nginx/vhosts/
vi firefore.com.conf #使用时请根据实际文件名，就是网址.conf的格式</pre>
</td>
</tr>
</table>
</div>

把error_page 404 /404.html这个段注释掉（在前面加入＃即可）

<img loading="lazy" decoding="async" class="alignnone size-full wp-image-1296" src="https://blog.natt.cc/wp-content/uploads/2017/02/2014-10-09_20-49-34.png" alt="" width="523" height="129" srcset="https://blog.natt.cc/wp-content/uploads/2017/02/2014-10-09_20-49-34.png 523w, https://blog.natt.cc/wp-content/uploads/2017/02/2014-10-09_20-49-34-350x86.png 350w, https://blog.natt.cc/wp-content/uploads/2017/02/2014-10-09_20-49-34-300x74.png 300w" sizes="auto, (max-width: 523px) 100vw, 523px" /> 
